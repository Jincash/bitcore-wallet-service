 ...
 * @param {string} opts.network[='livenet'] - The Botcoin network for this wallet.
 ...
 * @param {string} opts.unit - Botcoin unit used to format amounts in notifications.
 */
 ...
 * @param {string} [opts.network = 'livenet'] - The Botcoin network to estimate fee levels from.
 ...
 * @param {string} [opts.network = 'livenet'] - The Botcoin network for this transaction.
